...
<%!Connection conn = null;
	Statement st = null;
	ResultSet rs = null;
	String sid, sname, s1, f1, c1, s2, f2, c2, s3, f3, c3;%>
<%
	...
	if (sid == null)
		...
		try {
			...
			fee = (Fee) em.createQuery(
					"SELECT c FROM Fee c WHERE c.SID='" + sid + "'")
					.getSingleResult();
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		<table border="0" style="border-collapse: collapse" width="92%"
			...
			<tr>
				<td width="26%" height="144" valign="top"
					...
					<br> <b><font face="Arial">Fee Information</font></b>
					<p>
						<b> </b>
				</td>
				<td height="144" width="53%" valign="top"
					...
					<table border="1" style="border-collapse: collapse" width="100%"
						id="table3">
						<tr>
							<td bgcolor="#B7BCC6" colspan="3" align="center"><b> <font
									face="Arial">Fee</font></b></td>
						</tr>
						<tr>
							<td width="36%"><b><font face="Arial">Semester</font></b></td>
							<td width="23%"><b><font face="Arial">Total Fee</font></b></td>
							<td width="23%"><b><font face="Arial">Status</font></b></td>
						</tr>
						<tr>
							<td width="36%">Semester 1</td>
							<td width="23%"><%=fee.getFee1()%></td>
							<td width="23%"><%=fee.isPaid1()%></td>
						</tr>
						<tr>
							<td width="36%">Semester 2</td>
							<td width="23%"><%=fee.getFee2()%></td>
							<td width="23%"><%=fee.isPaid2()%></td>
						</tr>
						<tr>
							<td width="36%">&nbsp;</td>
							<td width="23%">&nbsp;</td>
