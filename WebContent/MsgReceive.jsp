				...
				<td colspan="3" height="22" valign="top" bgcolor="#B7BCC6"
					...
					<p align="right">
						<b><font face="Arial" size="1"> <a
								href="MsgReceive.jsp">&nbsp;Inbox( <%
 	out.println(msgCount);
 %> )
							</a> <a href="MsgSend.jsp">Compose Message</a>&nbsp; <a
			...
			<tr>
				...
				<td height="21" bgcolor="#B7BCC6" colspan="3">
					<p align="center">
			...
			<tr>
                <td width="20%" height="144" valign="top"
					...
					<p>
						<%
							...
							%>
							**msg&nbsp;<%=i%>&nbsp;**
							<br>&nbsp;&nbsp;&nbsp;Subject:&nbsp;<%=m.getSubject()%>
							<br>
							&nbsp;&nbsp;&nbsp;Message:&nbsp;<%=m.getMessage().subSequence(3,m.getMessage().length()-4)%>
							<%	
				...
				<td height="144" width="46%" valign="top"
				...
				<td height="144" width="23%" valign="top"
					style="border-left-style: dashed; border-left-width: 1px; border-right-style: dashed; border-right-width: 1px; border-bottom-style: dashed; border-bottom-width: 1px">
