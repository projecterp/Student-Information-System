...
<body background="images/background.gif" topmargin="0"
	...
	<form method="POST" action="fee" name="Registeration">
		...
		<table border="0" style="border-collapse: collapse" width="100%"
			...
			<tr>
				<td align="center" height="32" colspan="3"
					...
					bgcolor="#808080"><b><font size="5" face="Arial"
						color="#FFFFFF">Enter Fee Record</font></b></td>
			</tr>
			<tr>
			...
			<tr>
				<td width="214" align="center" height="23">&nbsp;</td>
				<td width="182" align="left" height="23"><font face="Arial">Sem
						I Fee Amount </font></td>
				<td height="23" align="left"><font face="Arial Narrow"><input
			...
			<tr>
				...
				<td width="182" align="left" height="23"><font face="Arial">Sem
						I Fee Paid? </font></td>
				<td height="23" align="left"><font face="Arial Narrow"><input
						type="checkbox" name="T4" size="23"></font><font size="2"
					face="Arial Narrow"></font></td>
			</tr>
			<tr>
				<td width="214" align="center" height="23">&nbsp;</td>
				<td width="182" align="left" height="23"><font face="Arial">Sem
						II Fee Amount</font></td>
				<td height="23" align="left"><font face="Arial Narrow"><input
			...
			<tr>
				...
				<td width="182" align="left" height="23"><font face="Arial">Sem
						II Fee Paid? </font></td>
				<td height="23" align="left"><font face="Arial Narrow"><input
						type="checkbox" name="T6" size="23"></font><font size="2"
					face="Arial Narrow"></font></td>
			</tr>
