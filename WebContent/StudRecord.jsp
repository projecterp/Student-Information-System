...
<%
	...
	if (sid == null)
		...
		out.println("Welcome to Administratorive Operations");
%>
<html>
		...
		<table border="0" style="border-collapse: collapse" width="92%"
			...
			<tr>
				<td height="22" valign="top" bgcolor="#B7BCC6"
					...
					<p align="right">
						<a href="logout.jsp"><b><font face="Arial" size="1">Logout&nbsp;&nbsp;&nbsp;
			...
			<tr>
				<td width="96%" height="139" bgcolor="#B7BCC6">
					...
					<form method="POST" action="sRec.jsp">

						<p align="center">
							User ID <input type="text" name="T1" size="20">
						</p>
						<p align="center">
