...
<body background="images/background.gif" topmargin="0"
	...
	<table border="0" style="border-collapse: collapse" width="92%"
		...
		<tr>
			<td height="19" valign="top" bgcolor="#B7BCC6"
				...
				<p align="right">
					<b><font face="Arial" size="1">Logout&nbsp;&nbsp;&nbsp;
	...
	<form method="POST" action="Sched" name="Registeration">
		...
		<table border="0" style="border-collapse: collapse" width="100%"
			...
			<tr>
				<td align="center" height="32" colspan="3"
					...
					bgcolor="#808080"><b><font size="5" face="Arial"
						color="#FFFFFF">Define Subject Schedule</font></b></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td height="22" align="left"><font face="Arial Narrow"><input
					...
					face="Arial Narrow"> (e.g. Chemistry)</font></td>
			</tr>
			<tr>
				...
				<td height="23" align="left"><select class="selectpicker"
					data-style="btn-primary" id="select" name="T2">
			...
			<tr>
				<td width="214" align="center" height="23">&nbsp;</td>
				<td width="182" align="left" height="23"><font face="Arial">Monday
						:</font></td>
				<td height="23" align="left"><font face="Arial Narrow"><input
						type="text" name="T3" size="23"></font><font size="2"
					face="Arial Narrow"> </font></td>
			</tr>
			<tr>
				<td width="214" align="center" height="23">&nbsp;</td>
				<td width="182" align="left" height="23"><font face="Arial">Tuesday
						:</font></td>
				<td height="23" align="left"><font face="Arial Narrow"><input
			...
			<tr>
				<td width="214" align="center" height="23">&nbsp;</td>
				<td width="182" align="left" height="23"><font face="Arial">Wednesday
						:</font></td>
				<td height="23" align="left"><font face="Arial Narrow"><input
						type="text" name="T5" size="23"></font><font size="2"
					face="Arial Narrow"> </font></td>
			</tr>
			<tr>
				<td width="214" align="center">&nbsp;</td>
				<td width="182" align="left"><font face="Arial">Thursday
						:</font></td>
				<td align="left"><font face="Arial Narrow"><input
						type="text" name="T6" size="23"></font></td>
			</tr>
			<tr>
				<td width="214" align="center">&nbsp;</td>
				<td width="182" align="left"><font face="Arial">Friday :</font></td>
				<td align="left"><font face="Arial Narrow"><input
			...
			<tr>
				...
				<td width="182" align="left" height="22"><font face="Arial">
						Saturday :</font></td>
				<td height="22" align="left"><font face="Arial Narrow"><input
						type="text" name="T8" size="23"></font><font size="2"
					face="Arial Narrow"></font></td>
			</tr>
		</table>
		<p align="center">
