<%@page import="servletdb.News"%>
<%@page import="servletdb.Message"%>
...
<%
	...
	if (sid == null)
		...
		msgList = (ArrayList<Message>) em.createQuery(
				"SELECT c from Message c where c.to='" + sid + "'",
				Message.class).getResultList();
		newsList = (ArrayList<News>) em.createQuery(
				"SELECT c From News c ",
				News.class).getResultList();
		//out.println("You Have "+msgList.size()+" Messages");
		///	out.print();
		//session.setAttribute("id",str);
		//session.setAttribute("name",name);
		/*
		try{
			String Query="SELECT * FROM Message WHERE To='"+sid+"'";
			...
			rs.last();
			msgCount=rs.getRow();
			out.println("You Have "+msgCount +" Messages");
		...
		<table border="0" style="border-collapse: collapse" width="92%"
				...
				<td colspan="3" height="22" valign="top" bgcolor="#B7BCC6"
					...
					<p align="right">
						<b><font face="Arial" size="1"> <a
								href="MsgReceive.jsp">&nbsp;Inbox( )</a> <a href="MsgSend.jsp">
									Compose Message</a>&nbsp; <a href="logout.jsp">Logout</a>&nbsp;&nbsp;
						</font></b>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td width="20%" height="144" valign="top"
					...
					%><p ><%out.println("**".concat(n.getContent()));%></p>
					<%
							}}
					%>
				</td>

				<td height="144" width="60%" valign="top"
					...
					<p align="center">
						<b><font face="Courier New" size="2" color="#FF0000">Dear
								Student You have received<%=msgList.size()%> messages. <br>
						</font></b><img border="0" src="images/mail.gif" width="48" height="48"><b><font
							face="Courier New" size="2" color="#FF0000"><br> <a
								href="MsgReceive.jsp">Click here to read messages</a></font></b>
					</p>
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<p>&nbsp;</p>
				...
				<td height="144" width="19%" valign="top"
					style="border-left-style: dashed; border-left-width: 1px; border-right-style: dashed; border-right-width: 1px; border-bottom-style: dashed; border-bottom-width: 1px">
