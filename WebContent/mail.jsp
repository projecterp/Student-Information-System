...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
							<div class="form-group">
								<label class="col-sm-2" for="inputSubject">To</label>
								<div class="col-sm-10">
									<input class="form-control" name="T1" id="inputSubject"
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input class="form-control" name="T2" id="inputSubject"
								...
								<div class="form-group">
									...
									<div class="col-sm-12">
										<textarea class="form-control" name="T3" id="description" rows="8"></textarea>
									</div>
								</div>
	...
	<script>
	  ...
	  function close(){
	  document.getElementById("modalCompose").style.display = 'none';
	  }  
	</script>
</body>
</html>
