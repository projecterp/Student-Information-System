...
<body background="images/background.gif" topmargin="0"
	...
	<form method="POST" action="GradeAdd" name="Registeration">
		...
		<table border="0" style="border-collapse: collapse" width="100%"
			...
			<tr>
				<td align="center" height="32" colspan="3"
					...
					bgcolor="#808080"><b><font size="5" face="Arial"
						color="#FFFFFF">Enter Grade Record</font></b></td>
			</tr>
			<tr>
			...
			<tr>
				<td width="214" align="center" height="23">&nbsp;</td>
				<td width="182" align="left" height="23"><font face="Arial">Month</font></td>
				<td height="23" align="left"><font face="Arial Narrow"><input
			...
			<tr>
				<td width="214" align="center" height="23">&nbsp;</td>
				<td width="182" align="left" height="23"><font face="Arial">Score</font></td>
				<td height="23" align="left"><font face="Arial Narrow"><input
